object frmMain: TfrmMain
  ...
  object ButtonRdAll: TButton
    ...
    Width = 73
    Height = 21
    Hint = #1057#1095#1080#1090#1072#1090#1100' '#1074#1089#1077' '#1088#1077#1075#1080#1089#1090#1088#1099' '#1074' '#1092#1072#1081#1083
    Caption = 'Read Regs'
    Enabled = False
    ParentShowHint = False
    ShowHint = True
  ...
  object EditACount: TEdit
    ...
    Width = 49
    Height = 21
    Hint = #1044#1083#1080#1090#1077#1083#1100#1085#1086#1089#1090#1100' '#1089#1080#1075#1085#1072#1083#1072' '#1072#1082#1090#1080#1072#1074#1072#1094#1080#1080' '#1087#1086#1089#1083#1077' Reset '#1074' '#1084#1089'.'
    ParentShowHint = False
    ShowHint = True
    TabOrder = 20
    Text = '50'
  ...
  object ButtonGetPC: TButton
    ...
    ShowHint = True
    TabOrder = 41
    OnClick = ButtonGetPCClick
  end
  object ButtonRdSram: TButton
    Left = 88
    Top = 208
    Width = 73
    Height = 21
    Hint = #1057#1095#1080#1090#1072#1090#1100' '#1074#1089#1102' SRAM (64 k'#1073#1072#1081#1090') '#1074' '#1092#1072#1081#1083
    Caption = 'Read SRAM'
    Enabled = False
    ParentShowHint = False
    ShowHint = True
